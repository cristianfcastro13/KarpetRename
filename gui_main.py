...
if __name__ == "__main__":
    ...
    # If the program was opened with a right-click context menu as 'Advanced Karpet Rename'
    if len(sys.argv) > 1:
        initial_directory = sys.argv[1]

    # If the program was opened with a right-click context menu as 'Simple Karpet Rename'
    if (len(sys.argv) > 2):
        if (sys.argv[2] == "fast"):
